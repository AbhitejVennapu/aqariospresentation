...
const CommonFeatureCard = ({ index }) => {
    const featuresList = [
        {
            ...
            content: ['Communication between teachers and students.',
        ...
        },
        {
            title: 'Flags',
            imageLink: FlagImage,
            content: ['Two flags: Attention Required and Resolved.',
        ...
        },
        {
            ...
            content: ['A combination of tasks and subtasks needs to be configured by teacher.',
        ...
        },
        {
            ...
            content: ['A new view is provided to the teachers with details about flags and progress of each student.',
    ...
    return (
        <React.Fragment>
            ...
            >
                <Typography variant='h5' sx={{ paddingBottom: '2rem' }}>{featuresList[index].title}</Typography>
                <Grid container spacing={2}>
                    <Grid item xs={12} md={index === 3 ? 6 : 8} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <List>
                            {featuresList[index].content?.map((entry) =>
                                <ListItem>{entry}</ListItem>)}
                        </List>
                    </Grid>
                    <Grid item xs={12} md={index === 3 ? 6 : 4} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <img src={featuresList[index].imageLink} alt='featureImage' height={index === 3 ? '75%' : '100%'} width='100%'></img>
                    </Grid>
                </Grid>
